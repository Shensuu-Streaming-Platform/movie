        ...
        <div className="aboutPage">
            <ContentWrapper>
				...
				<ul className="aboutSubText">
					...
					<li><b>Series Extravaganza:</b> Binge-watch your favorite shows or embark on new adventures with captivating series. Shensuu Movie offers a wide spectrum of TV shows and Series, encompassing everything from sitcoms and dramas to documentaries and reality TV.</li>
